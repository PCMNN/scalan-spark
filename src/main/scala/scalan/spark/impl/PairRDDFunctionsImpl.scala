...
trait PairRDDFunctionssAbs extends ScalanCommunityDsl with PairRDDFunctionss {
  ...
  class SPairRDDFunctionsImplElem[K:Elem, V:Elem](iso: Iso[SPairRDDFunctionsImplData[K, V], SPairRDDFunctionsImpl[K, V]]) extends SPairRDDFunctionsElem[K, V, SPairRDDFunctionsImplData[K, V], SPairRDDFunctionsImpl[K, V]](iso) {
    def convertSPairRDDFunctions(x: Rep[SPairRDDFunctions[K, V]]) = // Converter is not generated by meta
!!!("Cannot convert from SPairRDDFunctions to SPairRDDFunctionsImpl: missing fields List(wrappedValueOfBaseType)")
  }
