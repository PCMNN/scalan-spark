...
trait SparkConfsAbs extends ScalanCommunityDsl with SparkConfs {
  ...
  class SSparkConfImplElem(iso: Iso[SSparkConfImplData, SSparkConfImpl]) extends SSparkConfElem[SSparkConfImplData, SSparkConfImpl](iso) {
    def convertSSparkConf(x: Rep[SSparkConf]) = // Converter is not generated by meta
!!!("Cannot convert from SSparkConf to SSparkConfImpl: missing fields List(wrappedValueOfBaseType)")
  }
