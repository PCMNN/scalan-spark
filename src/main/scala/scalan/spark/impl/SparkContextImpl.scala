...
trait SparkContextsAbs extends ScalanCommunityDsl with SparkContexts {
  ...
  class SSparkContextImplElem(iso: Iso[SSparkContextImplData, SSparkContextImpl]) extends SSparkContextElem[SSparkContextImplData, SSparkContextImpl](iso) {
    def convertSSparkContext(x: Rep[SSparkContext]) = // Converter is not generated by meta
!!!("Cannot convert from SSparkContext to SSparkContextImpl: missing fields List(wrappedValueOfBaseType)")
  }
